...
CREATE TABLE `inquiry_types` (
  ...
  KEY `role_id` (`role_id`),
  CONSTRAINT `inquiry_types_ibfk_3` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `inquiry_types_ibfk_4` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
LOCK TABLES `inquiry_types` WRITE;
